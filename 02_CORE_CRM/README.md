...
| ~~**C-03**~~ | ~~Bestandsübernahme~~ **Entschieden: keine Migration. Bestand kommt aus PDF-Polizzen** — [Kapitel 14](14_POLIZZENIMPORT.md), — [Kapitel 13](13_STARTKONFIGURATION.md) §3 | — | — |
...
| **C-07** | Führt der Versicherer bereits vermittelte Verträge, die im CRM fehlen? **Einzige Gegenprobe auf Vollständigkeit des Polizzenimports** | Verlängerungslauf, Provisionsprüfung | Produktverantwortung mit dem Versicherer |
| **C-08** | Wird zur Extraktion aus PDF-Polizzen ein Sprachmodell eingesetzt? Wenn ja: selbst betrieben oder unter Auftragsverarbeitungsvertrag, an welchem Ort verarbeitet? | Stufe 2 des Imports | Geschäftsführung mit Datenschutzberatung |
