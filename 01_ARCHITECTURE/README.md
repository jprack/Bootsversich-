...
| [`03_LEAD_GENERATION_ENGINE/`](../03_LEAD_GENERATION_ENGINE/README.md) | **Füllt M2 fachlich aus.** Recherche, Bewertung und Übergabe der Zielorganisationen. Zwei Befunde mit Wirkung auf die Architektur: Der Markt ist endlich (Leitkennzahl Abdeckungsgrad statt Leadmenge) und Kaltakquise per E-Mail ist in AT und DE unzulässig — auch gegenüber Unternehmen |
| [`04_DEALER_DATABASE/`](../04_DEALER_DATABASE/README.md) | **Vertieft M4 (Dealer Hub) datenseitig.** Händler als Organisationsrolle, Standortmodell, historisierte Markenvertretungen, Händlerwert und Betreuungsklassen. Leitkennzahl ist der Aktualitätsgrad — nicht die Zahl der Datensätze |
