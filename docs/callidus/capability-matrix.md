...
**Regel:** Solange in der Spalte _Status_ einer Zeile nicht `VERIFIZIERT` steht,
...
| --- | -------------------- | ------------------------- | --- | --- | ------------------ | ------------------ | ------------------ | ----------------- | ------------------ | --- | -------------- | ------- | ------- | ------------ | ------------ | -------------- | -------------- | ----------------- | ------------------ | --------------- | ---------------- | ----------------------- |
| 1   | _(zu erheben)_       | `DEMO-PRODUCT-A`          | ?   | ?   | ?                  | ?                  | ?                  | ?                 | ?                  | ?   | ?              | ?       | ?       | ?            | ?            | ?              | ?              | —                 | —                  | `OFFENER PUNKT` | F-01, F-02, F-04 | `ManualCallidusAdapter` |
| 2   | _(zu erheben)_       | `DEMO-PRODUCT-B`          | ?   | ?   | ?                  | ?                  | ?                  | ?                 | ?                  | ?   | ?              | ?       | ?       | ?            | ?            | ?              | ?              | —                 | —                  | `OFFENER PUNKT` | F-01, F-02, F-04 | `ManualCallidusAdapter` |
...
**eigenen** Plattform verwendet (_Callidus Boat Intelligence Platform_,
